...
if (isset($_POST['Agregar_Mascota'])) {
  ...
  $Sexo = $_POST['Sexo'];
  $query = "INSERT INTO tabla_mascotas(Num_Registro_Mascota, Nombre_Mascota, Raza, Fecha_Nac, Sexo, Fecha_Registro_Mascota) VALUES (null, '$Nombre_Mascota', '$Raza',  '$Fecha_Nac', '$Sexo', CURDATE())";
