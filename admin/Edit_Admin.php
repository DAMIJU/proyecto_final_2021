...
if(isset($_POST['update'])){
  ...
  echo "<script>alert('Los datos se han actualizado correctamente');window.location='Config.php?modulo=ViewAdmin'</script>";
  }else{
     ...
     <div class="col-md-5 mx-auto">
       <div class="card card-body" style="background-color: #2D92CB;">
        ...
        <form action="" method="POST">
            ...
            <div class="form-group">
              <input type="text" name="Apellidos_Usuario" class="form-control" value="<?php echo $row['Apellidos_Usuario']; ?>" placeholder="Actualizar apellidos">
            </div>
            <div class="form-group">
