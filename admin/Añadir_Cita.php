...
if (isset($_POST['agregar_cita'])) {
  ...
  $query="SELECT * FROM tabla_dueño WHERE Num_Registro_Dueño = '$Num_Dueño'";
      $resultado= $con->query($query);
      $row=$resultado->fetch_assoc();
  $Cel_Dueño = $row['Celular'];
  $query2 = "INSERT INTO tabla_citas(Cel_Dueño, Num_Registro_Cita, Num_Dueño, Num_Mascota, Tipo_Cita, Fecha_Cita, Hora_Cita, Estado_Cita) VALUES ('$Cel_Dueño', NULL, '$Num_Dueño', '$Num_Mascota', '$Tipo_Cita, '$Fecha_Cita', '$Hora_Cita', 'Pendiente'";
  $ResultadoInsertCita = mysqli_query($con, $query2);
