...
include("DB/conexion.php");
  ...
  if(isset($_POST['delete'])){
    ...
    $query3="DELETE FROM tabla_citas WHERE Num_Registro_Cita = $Num_Registro_Cita";
    $ResultadoDeleteDueño = $con->query($query3);
  
    if($ResultadoDeleteDueño){
    echo "<script>alert('Los datos se han eliminado correctamente');window.location='Citas.php'</script>";
    }else{
   ...
   <div class="row">
     <div class="col-md-5 mx-auto">
       <div class="card card-body" style="background-color: #2D92CB;">
        ...
        <h3 class="modal-title" id="staticBackdropLabel" style="font-weight:bold">Eliminando la cita de <?php echo $row['Nombre_Mascota']; ?></h3>   
