...
if(isset($_POST['delete'])){
  ...
  $query3="DELETE FROM tabla_mascotas WHERE Num_Registro_Mascota = $Num_Registro_Mascota";
  $ResultadoDeleteMascota = $con->query($query3);
   ...
   <div class="row">
     <div class="col-md-5 mx-auto">
       <div class="card card-body" style="background-color: #2D92CB;">
        ...
        <h3 class="modal-title" id="staticBackdropLabel" style="font-weight:bold">Eliminando a <?php echo $row['Nombre_Mascota']; ?></h3>   
