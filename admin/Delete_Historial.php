...
if(isset($_POST['delete'])){
  ...
  $query3="DELETE FROM historial_mascota WHERE Num_Historial_Cita = $Num_Historial_Cita";
   ...
   <div class="row">
     <div class="col-md-5 mx-auto">
       <div class="card card-body" style="background-color: #2D92CB;">
        ...
        <h3 class="modal-title" id="staticBackdropLabel" style="font-weight:bold">Eliminando historial</h3>   
